Final Project for Causal Inference

CPD Project - Causal Inference
...
This project investigates the causal relationship between police officer rank and the likelihood of being penalized for sustained complaints. We utilize backdoor estimation techniques and DoubleML models to isolate causal effects while controlling for confounding variables such as race, gender, age, and allegation category.
...
Key Estimation Implementations
...
𝐸[𝑌𝑎] = \sum_{𝑍} 𝑝(𝑍) 𝐸[𝑌|𝐴 = 𝑎, 𝑍], where 𝑍 = {𝐶1, 𝐶2, 𝐶3, 𝐶4}
...
For further details, refer to the respective Jupyter notebooks and see CPD Final Report.
